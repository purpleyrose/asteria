...
pub fn load_elf(data: *const u8, load_base: u64) -> Option<u64> {
    ...
    for i in 0..header.e_phnum {
        ...
        let program_header = unsafe { &*(data.offset(ph_offset as isize) as *const ELF64ProgramHeader) };
        ...
        if program_header.p_type == PT_LOAD {
            ...
            unsafe {
                ...
                if program_header.p_memsz > program_header.p_filesz {
                    core::ptr::write_bytes(dest.add(program_header.p_filesz as usize), 0, (program_header.p_memsz - program_header.p_filesz) as usize);
                }
            }
        }
    }
